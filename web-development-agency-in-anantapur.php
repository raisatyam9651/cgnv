...
<head>
  <title>Web Development Agency in Anantapur | Cognivic Digital</title>
          ...
          <div class="row">
            <div class="col-md-7">
             <div class="content pr-5" data-aos="fade-right" data-aos-delay="400">
			  <h1 class="inner-banner-head">Web Development Agency in Anantapur</h1>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="owl-carousel owl-theme top-client-bar">
			    <div class="item">
                  <a href="javascript:void(0)" aria-label="Cognivic Digital client logo"> <img alt="Web Development Agency In Anantapur - Cognivic Digital trusted client" loading="lazy" src="images1/client-logo/1-1.png" /> </a>
                </div>
                
				   <div class="item">
                  <a href="javascript:void(0)" aria-label="Cognivic Digital client logo"> <img alt="Web Development Agency In Anantapur - Cognivic Digital trusted client" loading="lazy" src="images1/client-logo/2-11.png" /> </a>
                </div>
				
				  <div class="item">
                  <a href="javascript:void(0)" aria-label="Cognivic Digital client logo"> <img alt="Web Development Agency In Anantapur - Cognivic Digital trusted client" loading="lazy" src="images1/client-logo/3.png" /> </a>
                </div>
				
				  <div class="item">
                  <a href="javascript:void(0)" aria-label="Cognivic Digital client logo"> <img alt="Web Development Agency In Anantapur - Cognivic Digital trusted client" loading="lazy" src="images1/client-logo/4-1.png" /> </a>
                </div>
                
				  <div class="item">
                  <a href="javascript:void(0)" aria-label="Cognivic Digital client logo"> <img alt="Web Development Agency In Anantapur - Cognivic Digital trusted client" loading="lazy" src="images1/client-logo/5-1.png" /> </a>
                </div>
                
				 <div class="item">
                  <a href="javascript:void(0)" aria-label="Cognivic Digital client logo"> <img alt="Web Development Agency In Anantapur - Cognivic Digital trusted client" loading="lazy" src="images1/client-logo/6-1.png" /> </a>
                </div>
        ...
        <div class="container seprator-line">
          <div class="row">
            ...
            <div class="col-md-3 text-right">
              <img alt="Web Development Agency In Anantapur - Cognivic Digital trusted client" loading="lazy" src="images/scroll-down-arrow.webp" style="filter: invert(100%);" />
            </div>
          </div>
        </div>
